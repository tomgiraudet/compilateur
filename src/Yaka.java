...
/**************************************/
  ...
  static final public void declFonction() throws ParseException {
    ...
    jj_consume_token(ident);
                           declaration.declareFunction(YakaTokenManager.identLu); expression.openBlocFunction(YakaTokenManager.identLu);
    paramForms();
    bloc();
  ...
  static final public void paramForm() throws ParseException {
    type();
    jj_consume_token(ident);
                 declaration.defParam(YakaTokenManager.identLu);
  }
  ...
  static final public void defConst() throws ParseException {
    jj_consume_token(ident);
           declaration.defConstante(YakaTokenManager.identLu);
    jj_consume_token(44);
    valConst();
  }
  ...
  static final public void valConst() throws ParseException {
    ...
    case entier:
      jj_consume_token(entier);
            declaration.setConstante(Type.INT, YakaTokenManager.entierLu);
      break;
    case ident:
      jj_consume_token(ident);
                 declaration.setConstante(YakaTokenManager.identLu);
      break;
    case VRAI:
      jj_consume_token(VRAI);
           declaration.setConstante(Type.BOOL, Constante.TRUE);
      break;
    case FAUX:
      jj_consume_token(FAUX);
           declaration.setConstante(Type.BOOL, Constante.FALSE);
      break;
    default:
      jj_la1[6] = jj_gen;
      jj_consume_token(-1);
  ...
  static final public void declVar() throws ParseException {
    ...
    jj_consume_token(ident);
           declaration.defVariable(YakaTokenManager.identLu);
    label_6:
    while (true) {
      switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
      case 41:
  ...
  static final public void type() throws ParseException {
    ...
    case ENTIER:
      jj_consume_token(ENTIER);
             declaration.defType(Type.INT);
      break;
    case BOOLEEN:
      jj_consume_token(BOOLEEN);
              declaration.defType(Type.BOOL);
      break;
    default:
      jj_la1[8] = jj_gen;
      jj_consume_token(-1);
 ...
 */
  ...
  static final public void arguementsFonction() throws ParseException {
    jj_consume_token(40);
    switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
    case VRAI:
    case FAUX:
